...
const file_services_user_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x1eservices/user/proto/user.proto\x12\x04user\x1a\x1dpkg/proto/common/common.proto\"\xf2\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	".user.User\x12?\n" +
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB2Z0github.com/Riku-KANO/kube-ec/services/user/protob\x06proto3"
